...
* [Guia Sakai - Papel de usuário padrão](configurar_conta/README.md)
...
* [Guia Sakai - Papel de professor](sakai_professor/README.md)
    ...
    * [Como exportar a lista de alunos?](sakai_professorv/como_exportar_a_lista_de_alunos.md)
...
* Área do Professor - Gestão da ferramenta RiW
    ...
    * [Como enviar mensagem privada aos alunos?](gestao_turmas/como_enviar_mensagem_privada_aos_alunos.md)
...
* [Administrador - Gestão do conteúdo RiW](administrador_-_edicao_riw.md)
    ...
    * [Como adicionar, editar e excluir palavras no Glossário e nas Palavras-função?](como_adicionar_palavras_no_glossario.md)